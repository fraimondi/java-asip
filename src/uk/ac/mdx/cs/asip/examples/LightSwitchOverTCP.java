...
public class LightSwitchOverTCP extends SimpleTCPBoard {

	
	public LightSwitchOverTCP(String port) {
		super(port);
	}
	...
	public static void main(String[] args) {
		...
		LightSwitchOverTCP testBoard = new LightSwitchOverTCP("192.168.0.101");
